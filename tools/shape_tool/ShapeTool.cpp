...
class ShapeTool : Tool
{
	...
	{
		if(script.mouse_in_scene and not script.space.down)
		{
			...
			if(script.ctrl.down and mouse.scroll != 0) change_layer(mouse.scroll);
	...
	{
		if(script.space.down or not script.mouse_in_scene) return;
